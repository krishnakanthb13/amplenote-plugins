---
title: YTD Wrapped - Testing
uuid: 44bee46e-c732-11ef-8aef-3f3f5d9b418d
version: 358
created: '2024-12-31T10:17:03+05:30'
tags:
  - '-t/amplenote/testing'
---
...
| | |
|-|-|
|name|YTD Wrapped - Testing|
|icon|date_range|
|description<!-- {"cell":{"colwidth":108}} -->|Get a Year Summary of your Amplenote Usage.|
|instructions<!-- {"cell":{"colwidth":108}} -->|- Go to Application Options using `ctrl+o / cmd+o`<br />- Type in and search for `YTD Wrapped`and Click on it<br />- Enter the Year, Limit of top trending words, and If you require it for a Particular Tag, then add the Tag/s (#10)<br />- Upon clicking on Submit, you need to wait for the Plugin to Analyze the Logics and give you an wrapped report / annual review.<br />Note: Tasks / Word count, is based on note's created date.<br />Future: May be we can try something more visual. For now its just Text - December 31st, 2024|
|setting|YTD_Year|
|setting|Top_Number_of_Words|
|setting|TagS|
\

> **Time Invested:**
>
> \- December 31st, 2024 - 6h 53m - Added notes count based on created and last modified dates, task and words count based on created date. Also added a month wise segregation of this. Additionally to this an ascending sorted count of words list in all the searched notes are considered. User has the option to select the year manually, top number of list of trending words list, and you can do this based on a tag filter as well. Tried a big of Image integration as well, was not so successful in it, hence skipped it, for now. Cool. Well earlier to this, I was breaking my head for a couple of error, which were not getting resolved, and the data was not getting through, and it was all because the data year was going through as string and it was suppose to go in as numeric, hence it was getting dropped. Fixed it finally. It was working.
