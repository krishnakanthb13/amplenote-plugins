        ...
        insertText: {
            ...
            "Name_Tag": async function(app) {
                try {
                    ...
                    const result = await app.prompt("Enter your Search Filter criteria", {
						      actions: [
								{ label: "Save and Open" , value: "save" },
                        ...
                        inputs: [
							...
							// Hints
							{
								label: "(folders.): archived,deleted,vault,plugin <br> (not-assigned-any-tags.): untagged (shared-notes.): created,public,shared,shareReceived,notCreated,shareSent (creation-date.): thisWeek,today (low-level-queries.): saving,stale,indexing (Notes-contain-tasks.): taskLists"
							},
