---
title: Gallery
uuid: 7af791e0-5a39-11ef-82af-22074e34eefe
version: 2220
created: '2024-08-14T18:04:00+05:30'
tags:
  - '-1-working'
  - '-t/amplenote/testing'
---
...
|Description<!-- {"cell":{"colwidth":127}} -->|View, <mark style="color:#3CC07D;">List<!-- {"cycleColor":"27"} --></mark>, Export/Download all your Gallery Items!|
\

- ~~First remove the things which are involved in drop down the child images.~~

- ~~Instead of drop down, it should popup - slightly blurring out the background.~~

- ~~Left and Right arrow need to be present and it should be functional by both mouse and keyboard keys.~~

- ~~Escape should escape the popup window.~~

- <mark style="color:#F5614C;">I am thinking of skipping these for now!<!-- {"cycleColor":"23"} --></mark>

    - <mark style="color:#F5614C;">I will be giving you a lot of image properties, not just the markdown image link, hence these properties should show up in a right properties section of the webpage, which has a dark background<!-- {"cycleColor":"23"} --></mark>

    - <mark style="color:#F5614C;">The structure of the properties is given below and it is separated by comma, suggest me any other delimiter so that I can set it up to avoid if comma is present in other fields<!-- {"cycleColor":"23"} --></mark>

    - <mark style="color:#F5614C;">Then additional to these properties, it should separately show the loaded images properties<!-- {"cycleColor":"23"} --></mark>

    - <mark style="color:#F5614C;">Then on top it should have zoom, download options<!-- {"cycleColor":"23"} --></mark>

Properties: -image-gallery,\[Image_Gallery_240815_153617\](https://www.amplenote.com/notes/02cc5128-5aee-11ef-944a-22074e34eefe),https://www.amplenote.com/notes/02cc5128-5aee-11ef-944a-22074e34eefe,Image_Gallery_240815_153617,02cc5128-5aee-11ef-944a-22074e34eefe,8/15/2024, 3:36:17 PM,8/15/2024, 5:07:17 PM,https://images.amplenote.com/a8bd423c-4265-11ef-a3f4-6ef34fa959ce/8bacda78-06de-462d-b0ca-ed4c0ea0decc.png,8bacda78-06de-462d-b0ca-ed4c0ea0decc.png,No Caption Available or Unable to Fetch.

Ordered name of properties: notetags, notelink, noteurl, notename, noteuuid, notecreated, noteupdated, imageurl, imagename, caption

\

![](https://images.amplenote.com/7af791e0-5a39-11ef-82af-22074e34eefe/f84da71d-58ee-4d5d-aefe-dcaf9d02b013.png) [^1]
