---
title: Dice - Testing
uuid: 3e8d26be-becc-11ef-ae90-4faf2c64a4b0
version: 710
created: '2024-12-20T17:46:32+05:30'
tags:
  - '-t/amplenote/testing'
---
...
|instructions<!-- {"cell":{"colwidth":108}} -->|- Run the **`Dice: Basic`**from App Options by **`ctrl / cmd + o`.**<br />- At first, it give you blank boxes to fill up. (Next time it remember your previous inputs).<br />- You can play around with the options listed to get an extensive range of a result.<br />- Using, Look Up in your Notes option, you can select any available dropdowns for the Plugin to take you to the random note.<br />- Audit page has all the Dice rolls and other details depending on your selection.<br />**Note:** More options are on its way. Comment in the Installation page for any feedback or suggestion.<br /><mark style="color:#BBA215;">**- New features added (All features) - December 29th, 2024<br />     - (**<!-- {"cycleColor":"25"} --></mark>note-Option<mark style="color:#BBA215;">**) Table - Randomizer.<br />     - (**<!-- {"cycleColor":"25"} --></mark>app-Option<mark style="color:#BBA215;">**) Basic, Advanced, Specialized, 8 Ball, Ask Sai Baba, Fudge/Fate, Fantasy AGE Stunt - (Single Roll, Roll All At Once)..**<!-- {"cycleColor":"25"} --></mark>|
...
<mark style="color:undefined;">**Will I find love this year? 2024. Yes - definitely.**<!-- {"cycleColor":"60"} --></mark> \[19:58:35\] December 22nd, 2024

\

- ~~Audit Feature.~~

    - ~~Date-Time, Options selected, rolls, total, uuid/name/something of the lookup-note.~~ \[14:35:48\]

- ~~Review Other Options - Individually Available in app-Options.~~

- ~~See what all are the other options that you want to add to the existing options.~~

- Check for any bugs or limitations and enhancement etc.

    - When changing the Lookup Note value, first time it does not pick it up, and it only show the second time.

> **Time Invested:**
>
> \- **December 20th, 2024** - 2h 45m - created the basic version of the dice (containing number of dice, dice faces, min, max, keep, drop, explode, sort, unique) = user inputs, saving the previous roll options in the settings, main functional dice roll Function, sort based on user selection and pick up a note Function. Based on users selection, dice rolls and fetches a note uuid and logs. Next I have to incorporate navigate and audit log features to this Basic Option. Also need to check for any bugs or limitations and enhancement etc.
>
> \- **December 21st, 2024** - 4h 6m - Added and tested, Audit & Navigate feature. Also Implemented Sort by Tags (Tags + Name feature). Published and Discord publicity updated. Also added Fudge/Fate option, just with number of dice as the user input function.
>
> \- **December 22nd, 2024** - 7h 11m - Added Fantasy AGE Stunt - Single Roll, Fantasy AGE Stunt - Roll All At Once, Updated Readable Audit reports, Added, Fudge/Fate - Previous Roll and AGE ALL - Previous Roll. Table - Randomizer. The "Table - Randomizer" feature simplifies data shuffling within your data in your AN note Tables. It allows you to select a table, choose to preserve the first row or column, specify the number of randomization iterations, and even maintain an audit trail. This tool is valuable for various applications, such as generating random scenarios, shuffling data for analysis, or creating randomized quizzes. 8 Ball. Ask Sai Baba.
>
> \- **December 25rd, 2024** - 1h 34m - *Try the pending things mentioned in the ANP, and publish it by tomorrow and close it For now*. Advanced Arithmetic Operations, Audit - result, should be expandable. For Basic Option - Rest all Good! minor fixes, for better presentation. User selection - explain in single line. 🔥
>
> \- **December 29th, 2024** - h m - 
>
> **Total: 6h 51m**
