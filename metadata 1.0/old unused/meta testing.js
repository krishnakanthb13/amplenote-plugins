            ...
            "Name_Tag": async function(app) {
                try {
                        ...
                        inputs: [
                            ...
                            // Format selection option
                            {
                                ...
                                options: [
                                    ...
                                    { label: "Only Undocumented Notes (Empty)", value: "empty_content_only" },
                    ...
                    if (sortOption === "asc") {
					 ...
					 //let notesEmptyNames; ReferenceError: notesEmptyNames is not defined
					 //let notesE = [];
                    ...
                    for (let note of notes) {
                        ...
                        //let noteLinkE = self._createMDLinkFromNoteHandle(noteE);
