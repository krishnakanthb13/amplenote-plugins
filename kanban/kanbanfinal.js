...
<body>
  ...
  {
    "content": "Review task - When Tasks is completed - FinishedReview task - When Tasks is completed - FinishedReview task - When Tasks is completed - FinishedReview task - When Tasks is completed - FinishedReview task - When Tasks is completed - FinishedReview task - When Tasks is completed - FinishedReview task - When Tasks is completed - Finished",
    "hideUntil": 1726857000,
    "important": false,
    "noteUUID": "84881f96-782e-11ef-8173-f222b153c6e3",
    "score": 18.3,
  ...
  },
  {
    ...
    "hideUntil": null,
    "important": false,
    "noteUUID": "099c1f30-775c-11ef-89b8-eeba9115991d",
    "score": 1,
    "startAt": null,
    "urgent": false,
    "uuid": "90627b76-e2f1-44bb-a2df-2edace2c3393",
    "notename": "To Do",
    "noteurl": "https://www.amplenote.com/notes/099c1f30-775c-11ef-89b8-eeba9115991d",
    "tags": "-reports/-kanban"
  },
  {
    "content": "ip",
    "hideUntil": null,
    "important": false,
    "noteUUID": "09cde0f6-775c-11ef-89b8-eeba9115991d",
    "score": 1,
    "startAt": null,
    "urgent": false,
    "uuid": "e955bb69-e9fa-41c3-9879-ca708cc3d3d2",
    "notename": "In Progress",
    "noteurl": "https://www.amplenote.com/notes/09cde0f6-775c-11ef-89b8-eeba9115991d",
    "tags": "-reports/-kanban"
  },
  {
    "content": "completed",
  ...
  },
  {
    ...
    "hideUntil": null,
    "important": false,
    "noteUUID": "0a7b77b6-775c-11ef-bfb2-f222b153c6e3",
    "score": 1,
    "startAt": null,
    "urgent": false,
    "uuid": "426aa783-bb0e-4846-bb03-0c64777b5e3c",
    "notename": "Backlog",
    "noteurl": "https://www.amplenote.com/notes/0a7b77b6-775c-11ef-bfb2-f222b153c6e3",
    "tags": "-reports/-kanban"
  },
  {
    "content": "on hold",
    "hideUntil": null,
    "important": false,
    "noteUUID": "0ab83052-775c-11ef-bfb2-f222b153c6e3",
    "score": 1,
    "startAt": null,
    "urgent": false,
    "uuid": "48e73092-8699-4d12-a12a-9df717b50e93",
    "notename": "On Hold",
    "noteurl": "https://www.amplenote.com/notes/0ab83052-775c-11ef-bfb2-f222b153c6e3",
    "tags": "-reports/-kanban"
  }
];
...
try {
        ...
        // document.getElementById('cycleButton').addEventListener('click', updateValue);
		...
		function formatTaskRepeat(repeatInfo) {
			...
			// Format output
			return \`\${repeatFrequency.charAt(0).toUpperCase() + repeatFrequency.slice(1).toLowerCase()} 
			<strong>Starts At:</strong> \${formattedDate} at \${formattedTime}\`;
		}
		...
		function showTaskInfo(task, element) {
			...
			if (!infoDiv) {
				...
				infoDiv.innerHTML = \`
					...
					<!-- <strong>Note UUID:</strong> \${task.noteUUID}<br> -->
					<!-- <strong>UUID:</strong> \${task.uuid}<br> -->
					<!-- <strong>Note Name:</strong> \${task.notename}<br> -->
					<strong>Important:</strong> \${task.important}<br>
					<strong>Urgent:</strong> \${task.urgent}<br>
					<strong>Score:</strong> \${task.score}<br>
					<hr>
					<strong>Start At:</strong> \${formatTimestamp(task.startAt)}<br>
					<strong>Hide Until:</strong> \${formatTimestamp(task.hideUntil)}<br>
					<strong>End At:</strong> \${formatTimestamp(task.endAt)}<br>
					<strong>Repeat:</strong> \${formatTaskRepeat(task.repeat)}<br>
					<hr>
					<strong>Note Link:</strong> <a href="\${task.noteurl}" target="_blank">\${task.notename}</a><br>
        ...
        function renderKanbanBoard() {
            ...
            Object.keys(columns).forEach(note => {
                ...
                if (sortBy === 'Start Date') {
                    columns[note].pending.sort((a, b) => new Date(b.startAt) - new Date(a.startAt));
                ...
                columns[note].pending.forEach(task => {
					...
					// infoButton.className = 'task-button';
					// taskItem.appendChild(infoButton);
					// taskItem.onmouseover = () => showTaskInfo(task, taskItem);
					// taskItem.onmouseout = () => hideTaskInfo(taskItem);
