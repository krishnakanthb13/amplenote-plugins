    ...
    insertText: {
        ...
        "Digital": async function(app) {
            ...
            function formatDate(dateString, dateObj) {
                ...
                for (let i = 0; i < dateString.length; i++) {
                    switch (dateString[i]) {
                        ...
                        case 'c':
                            ...
                            break;
                        case 'w':
                            formattedString += dayOfWeekNumber(date, 'Sunday');
                            break;
                        case 'W':
                            formattedString += dayOfWeekNumber(date, 'Monday');
                            break;
                        case 'Y':
                ...
                console.log('Formatted String:', formattedString); // Log the formatted string
                return formattedString;
            }

            // Example usage:
            const date = new Date();
            console.log(formatDate('Y-M-d h:n:s A', date)); // Log the result
        }
    }
}
