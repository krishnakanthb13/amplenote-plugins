...
### <mark>Timestamp: UnixToDateTime</mark>

![](https://images.amplenote.com/0fc33c04-3d0a-11ef-92e0-6ef34fa959ce/a24be77e-7530-4377-9ebb-78eb130eff34.gif)
...
### <mark>Timestamp: Unix to Timestamp.</mark>

1. <mark style="color:#E5569E;">For Whom: \[Straight forward, just enters the Regular Timestamp of the Unix Format. If you need it!\]<!-- {"cycleColor":"32"} --></mark><!-- {"indent":1} -->

    1. <mark style="color:#9AD62A;">(Use cases may be, checking when the Unix was created! \[Copy Paste the Unix for backup!\])<!-- {"cycleColor":"26"} --></mark><!-- {"indent":2} -->

    1. <mark style="color:#F8D616;">How To: How To: This is a single step.<!-- {"cycleColor":"25"} --></mark> 

        1. <mark style="color:#F8D616;">Select the Unix timestamp that you want to change to Regular Timestamp, using the hover menu > more options > click on **`Timestamp: UnixToDateTime`**.<!-- {"cycleColor":"25"} --></mark> 

        1. <mark style="color:#F8D616;">This should only take a couple of seconds, voilà you have your Regular Timestamp of the Unix input given.=> (7/18/2024, 8:37:10 PM)<!-- {"cycleColor":"25"} --></mark>
...
|instructions|Please fine the Instructions here = [Timestamp Docs](https://www.amplenote.com/notes/dab3062a-3ead-11ef-a563-26e37c279344) |
...
- ~~Refer notes and start building one by one.~~
    ...
    - ~~Unix Timestamp~~
        ...
        - ~~Unix to Timestamp (7/18/2024, 8:37:10 PM)~~
...
1. [Welcome Note:](#Welcome_Note:) 
    ...
    1. [Demo:](#Demo:) 
        ...
        1. [Timestamp: UnixToDateTime](#Timestamp:_UnixToDateTime) 
    ...
    1. [Documentation:](#Documentation:) 
        ...
        1. [Timestamp: Unix to Timestamp.](#Timestamp:_Unix_to_Timestamp.) 
